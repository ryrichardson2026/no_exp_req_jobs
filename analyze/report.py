...
def main():
    ...
    p("  read at their true fill on disk. category is likewise persisted by enrich from")
    p("  the shared title table (normalize/category.py), additive; an unmatched title")
    p("  reads empty []. education_flag is adapter-populated. All other")
