...
const INNER = {
  ...
  // Grocery — Tabler ti-shopping-cart; a cart reads as groceries where Retail's bag reads as a store.
  "Grocery": '<path d="M6 19m-2 0a2 2 0 1 0 4 0a2 2 0 1 0 -4 0"/><path d="M17 19m-2 0a2 2 0 1 0 4 0a2 2 0 1 0 -4 0"/><path d="M17 17h-11v-14h-2"/><path d="M6 5l14 1l-1 7h-13"/>',
